  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center overflow-y-auto p-4">
      <div
        ...
        onClick={onClose}
      />
      <div className="animate-fade-in-scale relative mx-4 my-auto w-full max-w-lg max-h-[85vh] overflow-y-auto rounded-2xl border border-black-deep/8 bg-white p-6 shadow-2xl shadow-black/15 sm:p-8">
        <button
          onClick={onClose}
