...
export default function Footer() {
  ...
  const linkClass =
    "font-body text-xs text-black-deep/40 transition-colors hover:text-gold-accent cursor-pointer";
      ...
      <footer className="border-t border-black-deep/8 bg-white">
        <div className="mx-auto max-w-7xl px-4 py-5 sm:px-6 sm:py-6">
          ...
          <div className="flex flex-wrap items-center justify-center gap-x-5 gap-y-2">
            ...
            <span className="hidden sm:inline text-black-deep/15">·</span>
            <button
            ...
            <button
              ...
              className={
                linkClass + " !text-gold-accent/70 hover:!text-gold-accent"
              }
            >
              Donaciones ♥
            </button>
          ...
          <div className="mx-auto my-4 flex h-0.5 w-16 overflow-hidden rounded-full">
          ...
          {/* Bottom */}
          <p className="text-center font-body text-[11px] text-black-deep/25">
