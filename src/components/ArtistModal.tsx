...
export default function ArtistModal({ group, onClose }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto overscroll-contain">
      ...
      {/* Scroll wrapper – centers the card and allows full scroll */}
      <div className="relative z-10 flex min-h-full justify-center px-3 py-6 sm:px-4 sm:py-12">
        {/* Modal content */}
        <div className="animate-fade-in-scale w-full max-w-4xl self-start rounded-2xl border border-black-deep/8 bg-white shadow-2xl shadow-black/15">
          {/* Close button */}
          <button
            onClick={onClose}
          ...
          >
            {selected.image_url && (
              <img
                ...
                draggable={false}
                onContextMenu={(e) => e.preventDefault()}
                className="max-h-[80vh] w-auto select-none rounded-2xl object-contain"
              />
            )}
